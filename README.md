...
The first, simply downloads every year specified (Read the .py file) and all letters as separate HTML files. For example, of the year 2000-2001, 1st semester, letter B, this would be saved as 2000-2001 1-B.
...
2. Install the requirements using the following command while your terminal/command prompt window is in the same folder as the requirements.txt.
```python
...
Now obviously, the scraping can take some time. 
